        ...
        <div className="text-center">
          ...
          <div className="mb-12">
            <div className="flex flex-col md:flex-row gap-4 justify-center items-center">
              <a
                href="/work"
                className="w-full md:w-auto inline-flex items-center justify-center px-8 py-3 bg-blue-600 text-white font-semibold rounded-md hover:bg-blue-700 transition-colors duration-200"
              >
                View My Work
              </a>
              ...
              <a
                href="/skills"
                className="w-full md:w-auto inline-flex items-center justify-center px-8 py-3 bg-white text-blue-600 font-semibold rounded-md border-2 border-blue-600 hover:bg-blue-50 transition-colors duration-200"
              >
              ...
              <a
                href="/contact"
                className="w-full md:w-auto inline-flex items-center justify-center px-8 py-3 bg-gradient-to-r from-red-600 to-purple-600 text-white font-semibold rounded-md hover:from-purple-700 hover:to-pink-700 transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl"
              >
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
